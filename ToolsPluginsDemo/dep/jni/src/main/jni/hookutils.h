...
#define LogE(fmt, ...)    {LOGD(ANDROID_LOG_ERROR, "gameassist_test", fmt, ##__VA_ARGS__);printf(fmt,##__VA_ARGS__);}
...
inline char * stringToHexString(unsigned char *src, int src_len){
