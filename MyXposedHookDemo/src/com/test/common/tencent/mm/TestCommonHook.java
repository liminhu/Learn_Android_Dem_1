...
public static void test(){
    ...
    private boolean is_printf=false;
		...
		if(lpparam.packageName.equals(PACKAGE_NAME)){
			...
			XposedHelpers.findAndHookMethod("java.lang.StringBuilder", lpparam.classLoader, "toString",
				    ...
				    protected void afterHookedMethod(MethodHookParam param)
				    	...
				    	if(resultString.contains("onNotifyChange") ||  resultString.contains("5509122859@chatroom") || resultString.contains("0.01") || resultString.contains("huli") || resultString.contains("INSERT INTO")){
				    		test();
				    	}
			...
			// update(String arg5, ContentValues arg6, String arg7, String[] arg8) 
			XposedHelpers.findAndHookMethod("com.tencent.mm.bj.e", lpparam.classLoader, "update", String.class,
					 ContentValues.class, String.class, String[].class,
				    ...
				    protected void afterHookedMethod(MethodHookParam param)
				    	...
				    	Log.e("hook_update_af", ""+resultString);
				    	test();
				    }
				    ...
				    @Override
				    	protected void beforeHookedMethod(MethodHookParam param)
							...
							Log.e("hook_update_mm", ""+param.args[0]);
							Log.e("hook_update_mm", ""+param.args[1].toString());
							Log.e("hook_update_mm", ""+param.args[2]);
							List<String> list = Arrays.asList((String[])param.args[3]);
							Log.e("hook_update_mm", ""+list.toString());
				    	}
				});
