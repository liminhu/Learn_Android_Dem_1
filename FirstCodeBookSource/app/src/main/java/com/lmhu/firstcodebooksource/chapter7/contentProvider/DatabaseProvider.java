...
/**
 * Created by hulimin on 2017/3/18.
 */
...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY="com.lmhu.datebasetest.provider";
    ...
    public boolean onCreate() {
        dbHelper=new MyDatabaseHelper(getContext(), "BookStore1.db",null,2);
        return true;
    }
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
            ...
            case CATEGORY_ITEM:
                return "vnd.android.curso.item/vnd."+AUTHORITY+".category";
        }
        return null;
    }
}
